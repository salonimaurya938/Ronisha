...
<div id="ct-pagetitle" class="ct-pagetitle bg-image">
    <div class="container">
        <div class="ct-page-title-holder">
            <h1 class="ct-page-title">Privacy Policy</h1>
        </div>
        <ul class="ct-breadcrumb">
            <li><a class="breadcrumb-entry" href="../home-1-one-page/homeOne.html">Home</a></li>
            <li><span class="breadcrumb-entry">Privacy Policy</span></li>
        </ul>
    </div>
</div>
                    ...
                    <main id="main" class="site-main">
                        <article id="post-3" class="post-3 page type-page status-publish hentry">
                            <div class="entry-content clearfix">
                                <h2>Who we are</h2>
                                <p>Our website address is: www.ronishainformatics.com</p>
                                ...
                                <p>An anonymized string created from your email address (also called a hash) may
                                ...
                                <p>If you visit our login page, we will set a temporary cookie to determine if
                                ...
                                <p>When you log in, we will also set up several cookies to save your login
                                    ...
                                    out of your account, the login cookies will be removed.</p>
                                <p>If you edit or publish an article, an additional cookie will be saved in your
                                    ...
                                    ID of the article you just edited. It expires after 1 day.</p>
